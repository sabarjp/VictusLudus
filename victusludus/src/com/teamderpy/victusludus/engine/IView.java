...
/** A view is composed of a playing field and a GUI that renders over it. The engine can render one view at a time, typically the
 * game field with the HUD on it.
 * 
 * @author Josh */
