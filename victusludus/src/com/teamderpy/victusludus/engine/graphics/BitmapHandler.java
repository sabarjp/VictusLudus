...
public class BitmapHandler {
	...
	public static Animation LoadAnimationSheet (final String path, final int spritesPerRow, final int rowsPerSheet,
		final int firstFrame, final int lastFrame, final int speed) {
